...
import com.example.finedust.data.DustItem
import com.example.finedust.databinding.ActivityMainBinding
import com.example.finedust.retrofit.NetWorkClient
...
class MainActivity : AppCompatActivity() {
    ...
    private fun setUpDustParameter(sido: String): HashMap<String, String> {
        val authKey =
            "Ux155jCrjjYW0pK6ye/BZtyn7DrE2T45DkEAyKrE3YUKoMSv8517s5mXpA15drTPxas32y6pcIWczFy8jVayMg=="
